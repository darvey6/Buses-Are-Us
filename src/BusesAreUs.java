...
public class BusesAreUs extends Activity implements LocationListener, StopSelectionListener {
    ...
    private void initializeFragment(Bundle savedInstanceState) {
        if (savedInstanceState != null) {
            ...
            fragment = (MapDisplayFragment) getFragmentManager().findFragmentByTag(MAP_TAG);
            ...
            getFragmentManager().beginTransaction().add(R.id.map_fragment, fragment, MAP_TAG).commit();
        }
    }
    ...
    private class DownloadBusLocationDataTask extends AsyncTask<Stop, Integer, String> {
        ...
        protected void onPostExecute(String response) {
            if (response == null) {
                ...
                Toast.makeText(getApplicationContext(), "No bus location information available",
